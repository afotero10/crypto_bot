...
def datos_inicio(lista,tiempo_vela):
    ...
    if lista==1:
        ...
        if tiempo_vela == '1m':
            for i in list_simbolos:
                a = client.get_historical_klines(i, Client.KLINE_INTERVAL_1MINUTE, "50 day ago UTC")
                for x in a:
                    x.append(i)
                klines.extend(a)
            ...
            for i in list_simbolos:
                a = client.get_historical_klines(i, Client.KLINE_INTERVAL_15MINUTE, "300 min ago UTC")
                for x in a:
                    x.append(i)
                klines.extend(a)
    ...
    df_datos_iniciales.to_csv('datos_ini.csv')

    return df_datos_iniciales, list_simbolos
